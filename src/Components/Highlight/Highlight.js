            ...
            <div class="col-lg-6">
                <div class="troo_da_people_choose_left">
                    ...
                    <div class="troo_da_people_choose_title">
                        <h2>It’s simple. we’re here for you.
                            <span>troo handyman</span> services
                        </h2>
                    </div>
                    <div class="troo_da_people_choose_content">
                        <p>Lorem Ipsum is simply dummy and is text of the printing and typesetting industry. Lorem
                            Ipsum has been the industry's and standard dummy text ever since the 1500s, when an
                            unknown printer.</p>
                    </div>
                                ...
                                <div class="troo_da_detail_box_img">
                                    <svg width="62" height="62" viewBox="0 0 62 62" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="#022539" stroke-width="2" stroke-linecap="round"
